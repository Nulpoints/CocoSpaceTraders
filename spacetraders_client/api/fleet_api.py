...
from spacetraders_client.api_client import ApiClient, RequestSerialized
from spacetraders_client.api_response import ApiResponse
from spacetraders_client.rest import RESTResponseType
...
class FleetApi:
    ...
    def _extract_resources_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if extract_resources_request is not None:
            _body_params = extract_resources_request
    ...
    def negotiate_contract_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NegotiateContract200Response]:
        """Negotiate Contract
    ...
    def purchase_ship(
        self,
        purchase_ship_request: Optional[PurchaseShipRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def transfer_cargo(
        self,
        ship_symbol: Annotated[StrictStr, Field(description="The transferring ship's symbol.")],
    ...
    def warp_ship_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WarpShip200Response]:
        """Warp Ship
