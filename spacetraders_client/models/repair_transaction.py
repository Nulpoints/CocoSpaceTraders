...
class RepairTransaction(BaseModel):
    ...
    ship_symbol: StrictStr = Field(description="The symbol of the ship.", alias="shipSymbol")
    ...
    __properties: ClassVar[List[str]] = ["waypointSymbol", "shipSymbol", "totalPrice", "timestamp"]
