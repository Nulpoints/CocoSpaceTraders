...
class Ship(BaseModel):
    ...
    Ship details.
    """ # noqa: E501
    symbol: StrictStr = Field(description="The globally unique identifier of the ship in the following format: `[AGENT_SYMBOL]-[HEX_ID]`")
    ...
    __properties: ClassVar[List[str]] = ["symbol", "registration", "nav", "crew", "frame", "reactor", "engine", "cooldown", "modules", "mounts", "cargo", "fuel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "registration": ShipRegistration.from_dict(obj["registration"]) if obj.get("registration") is not None else None,
            "nav": ShipNav.from_dict(obj["nav"]) if obj.get("nav") is not None else None,
            "crew": ShipCrew.from_dict(obj["crew"]) if obj.get("crew") is not None else None,
            ...
            "fuel": ShipFuel.from_dict(obj["fuel"]) if obj.get("fuel") is not None else None
        })
