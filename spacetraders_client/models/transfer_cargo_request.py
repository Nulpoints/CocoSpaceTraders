...
class TransferCargoRequest(BaseModel):
    ...
    units: StrictInt = Field(description="Amount of units to transfer.")
    ship_symbol: StrictStr = Field(description="The symbol of the ship to transfer to.", alias="shipSymbol")
