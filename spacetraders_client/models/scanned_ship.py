...
class ScannedShip(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "frame": ScannedShipFrame.from_dict(obj["frame"]) if obj.get("frame") is not None else None,
            "reactor": ScannedShipReactor.from_dict(obj["reactor"]) if obj.get("reactor") is not None else None,
            "engine": ScannedShipEngine.from_dict(obj["engine"]) if obj.get("engine") is not None else None,
            "mounts": [ScannedShipMountsInner.from_dict(_item) for _item in obj["mounts"]] if obj.get("mounts") is not None else None
        })
