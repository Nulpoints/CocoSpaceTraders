...
class ExtractResources201ResponseData(BaseModel):
    ...
    cargo: ShipCargo
    events: List[ExtractResources201ResponseDataEventsInner]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["cooldown", "extraction", "cargo", "events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "extraction": Extraction.from_dict(obj["extraction"]) if obj.get("extraction") is not None else None,
            "cargo": ShipCargo.from_dict(obj["cargo"]) if obj.get("cargo") is not None else None,
            "events": [ExtractResources201ResponseDataEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
